...
$instant_enable = true; // active la gauge "instantanée"
$instant_delai = 60 * 1000; // relancé toutes les 60 secondes

$tarif_type = "HCHP"; // vaut soit "BASE", soit "HCHP", soit "EJP.", soit "BBRX" (TEMPO)
...
function queryinstant ($timestamp) {
  global $table;//, $tarif_type;

  $query="SELECT timestamp, rec_date, rec_time, ptec, papp, pmax, inst1 AS iinst1, imax1, isousc,  
    hchp AS hp, 
    hchc AS hc 
    FROM `$table`
